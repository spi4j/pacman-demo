 ...
 */
@Configuration
@OpenAPIDefinition(info = @Info(title = "demo-dsfr", version = "3.0.3", description = "DESCRIPTION A IMPLEMENTER", termsOfService = "", contact = @Contact(name = "", email = "", url = ""), license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html")))
