 ...
 * @author MINARM
 */
public class Demo_dsfr_restAuthenticationException extends RuntimeException {
	 ...
	 * Constructeur.
	 */
	public Demo_dsfr_restAuthenticationException(final int statusCode, final String msg) {
		super(msg);
