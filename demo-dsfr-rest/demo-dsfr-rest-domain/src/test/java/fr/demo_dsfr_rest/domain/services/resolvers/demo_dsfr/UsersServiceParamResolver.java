...
import fr.demo_dsfr_rest.domain.services.demo_dsfr.UsersServiceImpl;
 ...
 * instance de {@link UsersServiceImpl}. Elle est utilisée pour injecter une
 * instance de {@link UsersServiceImpl} dans les tests de manière automatique.
 * 
 ...
 * paramètre en créant une instance de {@link UsersServiceImpl}.
 * <p>
 * Le resolveur permet d'injecter automatiquement le stub (au lieu de la couche
 * de persistance) dans l'instance de {@link UsersServiceImpl}.
 * <p>
 ...
 * @see UsersProvider
 * @see UsersProviderStubImpl
 */
public class UsersServiceParamResolver implements ParameterResolver {
	...
	public boolean supportsParameter(ParameterContext parameterContext, ExtensionContext extensionContext)
		...
		return parameterContext.getParameter().getType() == UsersServiceImpl.class;
	}

	/**
	 * Résout le paramètre en créant une instance de {@link UsersServiceImpl} avec
	 * un {@link UsersProvider}. Dans cet exemple, un stub de {@link UsersProvider}
	 * est utilisé pour les tests.
	 * 
	 * @param parameterContext le contexte du paramètre à résoudre
	 * @param extensionContext le contexte de l'extension du test
	 * @return une instance de {@link UsersServiceImpl} prête à être utilisée dans
	 *         le test
	 * @throws ParameterResolutionException si une erreur se produit lors de la
	 *                                      résolution du paramètre
	 */
	...
	public Object resolveParameter(ParameterContext parameterContext, ExtensionContext extensionContext)
			throws ParameterResolutionException {
		UsersProvider provider = new UsersProviderStubImpl();
		return new UsersServiceImpl(provider);
	}
}
